    ...
    return (
        <div className="flex flex-col justify-center items-center w-11/12 lg:w-1/2 min-h-[50vh] my-4 mx-auto">
            <div className="bg-highlight p-6 lg:p-12 rounded-md shadow-md">
                <h1 className="text-2xl lg:text-4xl text-center font-semibold text-primary text-background mb-8">Applications for TerraHacks 2025 Are Now <span className="text-red-400">Closed!</span></h1>
